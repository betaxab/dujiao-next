...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.card_secret_batch_update_failed":          "更新卡密批次失败",
		"error.card_secret_batch_not_found":              "卡密批次不存在",
	...
	LocaleTW: {
		...
		"error.card_secret_batch_update_failed":          "更新卡密批次失敗",
		"error.card_secret_batch_not_found":              "卡密批次不存在",
	...
	LocaleEN: {
		...
		"error.card_secret_batch_update_failed":          "Failed to update card secret batch",
		"error.card_secret_batch_not_found":              "Card secret batch not found",
